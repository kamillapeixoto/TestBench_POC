...
xlabel('Settings');
ylabel('Reduction of RMS Current (A)');
xticks(averages0(:,1));
xlim([0 5.25]);
...
legend('75%', '100%',  'Location','southeast');
...
folderPath = 'C:\Users\kamil\OneDrive\Documents\GitHub\Internship\PosProcessing\Results\AcceptanceTest\AutoPulse25';  
