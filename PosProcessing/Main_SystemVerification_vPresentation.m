...
% Create a figure for Figure 2: Flow Data
figure();
hold on;
...
% Add text labels
text(0.8, 1.2, 'I', 'FontSize', 16, 'FontWeight', 'bold')
text(2.95, 1.2, 'II', 'FontSize', 16, 'FontWeight', 'bold')
text(4.75, 1.2, 'III', 'FontSize', 16, 'FontWeight', 'bold')
...
% Create a figure for Figure 3: Temperature Data
figure();
hold on;
...
plot ([1.62 1.62], [22 34], '-.', 'color', 'black', 'LineWidth', 1.5)
plot ([4.37 4.37], [22 34], '-.', 'color', 'black', 'LineWidth', 1.5)
...
% Add text labels
text(0.8, 33.2, 'I', 'FontSize', 16, 'FontWeight', 'bold')
text(2.95, 33.2, 'II', 'FontSize', 16, 'FontWeight', 'bold')
text(4.75, 33.2, 'III', 'FontSize', 16, 'FontWeight', 'bold')
...
% Add text labels
text(0.8, 99, 'I', 'FontSize', fontsize_text, 'FontWeight', 'bold')
text(2.95, 99, 'II', 'FontSize', fontsize_text, 'FontWeight', 'bold')
text(4.75, 99, 'III', 'FontSize', fontsize_text, 'FontWeight', 'bold')

% Add labels and title
xlabel('Settings', 'FontSize', fontsize_xlabel);
ylabel('O2 Concentration (%)', 'FontSize', fontsize_ylabel);
%title('System Verification Tests', 'FontSize', 16);
xlim([0 5.25])
%xticks(0.25:0.25:5)
...
% Add legend
legend('Testbench', 'IMT', 'Location', 'southeast', 'FontSize', fontsize_legend);
...
% Add text labels
text(0.8, 1.2, 'I', 'FontSize', fontsize_text, 'FontWeight', 'bold')
text(2.95, 1.2, 'II', 'FontSize', fontsize_text, 'FontWeight', 'bold')
text(4.75, 1.2, 'III', 'FontSize', fontsize_text, 'FontWeight', 'bold')
...
% Add labels and title
xlabel('Settings', 'FontSize', fontsize_xlabel);
ylabel('Flow (L/min)', 'FontSize', fontsize_ylabel);
%title('System Verification Tests');
xlim([0 5.25])
% Add legend
legend('Testbench', 'IMT', 'Location', 'southeast', 'FontSize', fontsize_legend);
...
% Add labels and title
xlabel('Settings', 'FontSize', fontsize_xlabel);
ylabel('Temperature (°C)', 'FontSize', fontsize_ylabel);
%title('System Verification Tests');
xlim([0 5.25])
ylim([22 34])
...
% Add text labels
text(0.8, 33.2, 'I', 'FontSize', fontsize_text, 'FontWeight', 'bold')
text(2.95, 33.2, 'II', 'FontSize', fontsize_text, 'FontWeight', 'bold')
text(4.75, 33.2, 'III', 'FontSize', fontsize_text, 'FontWeight', 'bold')

% Adjust the figure properties
grid on;
hold off;

% Create a figure for Figure 4: Error of O2 Concentration - Humidity effect
figure();
hold on;
...
ylim([85 100]);
yticks([87:3:100]);
xticks(0.25:0.25:1.5)
% Adjust the figure properties
grid on;
hold off;

% Add legend
legend('Procheck', 'Testbench', 'IMT', 'Location', 'southeast', 'FontSize', fontsize_legend);

% Create a figure for Figure 5: Humidity effect on measurements
figure();
hold on;
...
text(0.8, 20, 'I', 'FontSize', fontsize_text, 'FontWeight', 'bold')
% Add labels and title
xlabel('Settings', 'FontSize', fontsize_xlabel);
ylabel('Humidity (%)', 'FontSize', fontsize_ylabel);
ylim([0 22])
% Adjust the figure properties
grid on;
hold off;
% Add legend
legend('Exp 1', 'Exp 2', 'Location', 'northeast', 'FontSize', fontsize_legend);

% Create a figure for Figure 6: Error of flow - Humidity effect
figure();
hold on;
...
% Create a figure for Figure 7: Error of temperature - Humidity effect
figure();
hold on;
...
% Create a figure for Figure 8: Flow Data - Humidity effect
figure();
hold on;
...
% Create a figure for Figure 9: Temperature Data - Humidity effect
figure();
hold on;
...
% Add legend
legend('Testbench', 'IMT', 'FontSize', fontsize_legend);
...
folderPath = 'C:\Users\kamil\OneDrive\Documents\GitHub\Internship\PosProcessing\Results\PresentationSystemVerification';  
